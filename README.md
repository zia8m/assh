...
1. [Setup - The basics of getting started with assh](#setup)
    * [What assh affects](#what-assh-affects)
    * [Setup requirements](#setup-requirements)
    * [Beginning with assh](#beginning-with-assh)
